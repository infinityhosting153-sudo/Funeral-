...
const clientSectionRoutes = [
  ...
  { path: '/client/beneficiaries/new', menu: 'beneficiaries' },
  { path: '/client/claims', menu: 'claims' },
  { path: '/client/payments', menu: 'payments' },
  { path: '/client/payments/top-up', menu: 'payments' },
  { path: '/client/payments/pay', menu: 'payments' },
  { path: '/client/communication', menu: 'communication' },
  { path: '/client/documents', menu: 'documents' },
  { path: '/client/documents/upload', menu: 'documents' },
